...
#include "EITimelinerEditorMode.generated.h"
 ...
 */
UCLASS()
class UEITimelinerEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_EITimelinerEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UEITimelinerEditorMode();
	virtual ~UEITimelinerEditorMode();
