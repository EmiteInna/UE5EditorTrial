...
#include "EITimelinerInteractiveTool.generated.h"
 ...
 */
UCLASS()
class EITIMELINER_API UEITimelinerInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class EITIMELINER_API UEITimelinerInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UEITimelinerInteractiveToolProperties();
 ...
 */
UCLASS()
class EITIMELINER_API UEITimelinerInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UEITimelinerInteractiveToolProperties> Properties;
