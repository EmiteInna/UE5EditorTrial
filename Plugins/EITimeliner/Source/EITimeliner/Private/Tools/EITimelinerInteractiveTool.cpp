...
#include "EITimelinerInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UEITimelinerInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UEITimelinerInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UEITimelinerInteractiveTool* NewTool = NewObject<UEITimelinerInteractiveTool>(SceneState.ToolManager);
...
void UEITimelinerInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UEITimelinerInteractiveTool::Setup()
{
	...
	Properties = NewObject<UEITimelinerInteractiveToolProperties>(this, "Measurement");
...
void UEITimelinerInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UEITimelinerInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UEITimelinerInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UEITimelinerInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UEITimelinerInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UEITimelinerInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UEITimelinerInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UEITimelinerInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UEITimelinerInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
