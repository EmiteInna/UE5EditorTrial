#include "FEITimeSliderController.h"
...
#include "Widgets/SEITimelineContainer.h"
...
FEITimeSliderController::FEITimeSliderController( const FTimeSliderArgs& InArgs,
		TWeakPtr<SEITimelineContainer> Container,
		TSharedPtr<INumericTypeInterface<double>> InSecondaryNumericTypeInterface,
		const TSharedPtr<FEITimelinerContext>& InContext)
...
FFrameTime FEITimeSliderController::ComputeFrameTimeFromMouse(const FGeometry& Geometry, FVector2D ScreenSpacePosition, FScrubRangeToScreen RangeToScreen, bool CheckSnapping) const
{
...
FEITimeSliderController::FScrubPixelRange FEITimeSliderController::GetHitTestScrubberPixelRange(FFrameTime ScrubTime, const FScrubRangeToScreen& RangeToScreen) const
{
...
FEITimeSliderController::FScrubPixelRange FEITimeSliderController::GetScrubberPixelRange(FFrameTime ScrubTime, const FScrubRangeToScreen& RangeToScreen) const
{
	return GetScrubberPixelRange(ScrubTime, GetTickResolution(), GetDisplayRate(), RangeToScreen);
}

FEITimeSliderController::FScrubPixelRange FEITimeSliderController::GetScrubberPixelRange(FFrameTime ScrubTime, FFrameRate Resolution, FFrameRate PlayRate, const FScrubRangeToScreen& RangeToScreen, float DilationPixels) const
{
...
struct FEITimeSliderController::FDrawTickArgs
{
...
void FEITimeSliderController::DrawTicks( FSlateWindowElementList& OutDrawElements, const TRange<double>& ViewRange, const FScrubRangeToScreen& RangeToScreen, FDrawTickArgs& InArgs ) const
{
	TSharedPtr<SEITimelineContainer> Timeline = WeakTimeline.Pin();
	if(!Timeline.IsValid())
	{
		return;
	}
...
int32 FEITimeSliderController::OnPaintTimeSlider( bool bMirrorLabels, const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled ) const
{
...
int32 FEITimeSliderController::DrawSelectionRange(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen, const FPaintPlaybackRangeArgs& Args) const
{
...
int32 FEITimeSliderController::DrawPlaybackRange(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen, const FPaintPlaybackRangeArgs& Args) const
{
...
int32 FEITimeSliderController::DrawEditableTimes(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen) const
{
	...
	for(double Time : Context.Pin()->EditingModel.Pin()->EditableItems)
	{
...
FReply FEITimeSliderController::OnMouseButtonUp( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
...
FReply FEITimeSliderController::OnMouseMove( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
...
void FEITimeSliderController::CommitScrubPosition( FFrameTime NewValue, bool bIsScrubbing )
{
...
FReply FEITimeSliderController::OnMouseWheel( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
...
FCursorReply FEITimeSliderController::OnCursorQuery( TSharedRef<const SWidget> WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& CursorEvent ) const
{
...
int32 FEITimeSliderController::OnPaintViewArea( const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, bool bEnabled, const FPaintViewAreaArgs& Args ) const
{
	const ESlateDrawEffect DrawEffects = bEnabled ? ESlateDrawEffect::None : ESlateDrawEffect::DisabledEffect;
...
FFrameTime FEITimeSliderController::GetFrameTimeFromMouse(const FGeometry& Geometry, FVector2D ScreenSpacePosition) const
{
...
TSharedRef<SWidget> FEITimeSliderController::OpenSetPlaybackRangeMenu(FFrameNumber FrameNumber)
{
...
void FEITimeSliderController::ClampViewRange(double& NewRangeMin, double& NewRangeMax)
{
...
void FEITimeSliderController::SetViewRange( double NewRangeMin, double NewRangeMax, EViewRangeInterpolation Interpolation )
{
...
void FEITimeSliderController::SetClampRange( double NewRangeMin, double NewRangeMax )
{
...
void FEITimeSliderController::SetPlayRange( FFrameNumber RangeStart, int32 RangeDuration )
{
...
bool FEITimeSliderController::ZoomByDelta( float InDelta, float MousePositionFraction )
{
...
void FEITimeSliderController::PanByDelta( float InDelta )
{
...
bool FEITimeSliderController::HitTestRangeStart(const FScrubRangeToScreen& RangeToScreen, const TRange<double>& Range, float HitPixel) const
{
...
bool FEITimeSliderController::HitTestRangeEnd(const FScrubRangeToScreen& RangeToScreen, const TRange<double>& Range, float HitPixel) const
{
...
bool FEITimeSliderController::HitTestTime(const FScrubRangeToScreen& RangeToScreen, double Time, float HitPixel) const
{
...
void FEITimeSliderController::SetPlaybackRangeStart(FFrameNumber NewStart)
{
	TRange<FFrameNumber> PlaybackRange = TimeSliderArgs.PlaybackRange.Get();
...
void FEITimeSliderController::SetPlaybackRangeEnd(FFrameNumber NewEnd)
{
	TRange<FFrameNumber> PlaybackRange = TimeSliderArgs.PlaybackRange.Get();
...
void FEITimeSliderController::SetSelectionRangeStart(FFrameNumber NewStart)
{
	TRange<FFrameNumber> SelectionRange = TimeSliderArgs.SelectionRange.Get();
...
void FEITimeSliderController::SetSelectionRangeEnd(FFrameNumber NewEnd)
{
	TRange<FFrameNumber> SelectionRange = TimeSliderArgs.SelectionRange.Get();
...
int32 FEITimeSliderController::HitTestTimes(const FScrubRangeToScreen& RangeToScreen, float HitPixel) const
{
	const TArray<double>& Times = Context.Pin()->EditingModel.Pin()->EditableItems;
	int32 NumTimes = Times.Num();
	for(int32 TimeIndex = 0; TimeIndex < NumTimes; ++TimeIndex)
	{
		const double Time = Context.Pin()->EditingModel.Pin()->EditableItems[TimeIndex];
...
void FEITimeSliderController::SetEditableTime(int32 TimeIndex, float Time, bool bIsDragging)
{
	if (Context.Pin()->EditingModel.IsValid())
	{
		if (Context.Pin()->EditingModel.Pin()->EditableItems.Num()>TimeIndex)
		{
			Context.Pin()->EditingModel.Pin()->EditableItems[TimeIndex] = Time;
		}
	}
}
