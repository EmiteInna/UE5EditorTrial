...
struct FKuruTimeSliderController::FScrubRangeToScreen
{
	double ViewStart;
...
FKuruTimeSliderController::FKuruTimeSliderController( const FTimeSliderArgs& InArgs,UKuruStoryClipData* InData,TWeakPtr<SKuruTimelineContainer> Container, TSharedPtr<INumericTypeInterface<double>> InSecondaryNumericTypeInterface )
	: mEditingData(InData)
	, WeakTimeline(Container)
...
FFrameTime FKuruTimeSliderController::ComputeFrameTimeFromMouse(const FGeometry& Geometry, FVector2D ScreenSpacePosition, FScrubRangeToScreen RangeToScreen, bool CheckSnapping) const
{
...
FKuruTimeSliderController::FScrubPixelRange FKuruTimeSliderController::GetHitTestScrubberPixelRange(FFrameTime ScrubTime, const FScrubRangeToScreen& RangeToScreen) const
{
...
FKuruTimeSliderController::FScrubPixelRange FKuruTimeSliderController::GetScrubberPixelRange(FFrameTime ScrubTime, const FScrubRangeToScreen& RangeToScreen) const
{
	return GetScrubberPixelRange(ScrubTime, GetTickResolution(), GetDisplayRate(), RangeToScreen);
}

FKuruTimeSliderController::FScrubPixelRange FKuruTimeSliderController::GetScrubberPixelRange(FFrameTime ScrubTime, FFrameRate Resolution, FFrameRate PlayRate, const FScrubRangeToScreen& RangeToScreen, float DilationPixels) const
{
...
struct FKuruTimeSliderController::FDrawTickArgs
{
...
void FKuruTimeSliderController::DrawTicks( FSlateWindowElementList& OutDrawElements, const TRange<double>& ViewRange, const FScrubRangeToScreen& RangeToScreen, FDrawTickArgs& InArgs ) const
{
	TSharedPtr<SKuruTimelineContainer> Timeline = WeakTimeline.Pin();
	if(!Timeline.IsValid())
	{
		return;
	}
...
int32 FKuruTimeSliderController::OnPaintTimeSlider( bool bMirrorLabels, const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled ) const
{
...
int32 FKuruTimeSliderController::DrawSelectionRange(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen, const FPaintPlaybackRangeArgs& Args) const
{
...
int32 FKuruTimeSliderController::DrawPlaybackRange(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen, const FPaintPlaybackRangeArgs& Args) const
{
...
int32 FKuruTimeSliderController::DrawEditableTimes(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen) const
{
	...
	for(double Time : mEditingData->EditableItems)
	{
...
FReply FKuruTimeSliderController::OnMouseButtonDown( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
	DistanceDragged = 0;
...
FReply FKuruTimeSliderController::OnMouseButtonUp( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
...
FReply FKuruTimeSliderController::OnMouseMove( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
...
void FKuruTimeSliderController::CommitScrubPosition( FFrameTime NewValue, bool bIsScrubbing )
{
...
FReply FKuruTimeSliderController::OnMouseWheel( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
...
FCursorReply FKuruTimeSliderController::OnCursorQuery( TSharedRef<const SWidget> WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& CursorEvent ) const
{
...
int32 FKuruTimeSliderController::OnPaintViewArea( const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, bool bEnabled, const FPaintViewAreaArgs& Args ) const
{
	const ESlateDrawEffect DrawEffects = bEnabled ? ESlateDrawEffect::None : ESlateDrawEffect::DisabledEffect;
...
FFrameTime FKuruTimeSliderController::GetFrameTimeFromMouse(const FGeometry& Geometry, FVector2D ScreenSpacePosition) const
{
...
TSharedRef<SWidget> FKuruTimeSliderController::OpenSetPlaybackRangeMenu(FFrameNumber FrameNumber)
{
...
void FKuruTimeSliderController::ClampViewRange(double& NewRangeMin, double& NewRangeMax)
{
...
void FKuruTimeSliderController::SetViewRange( double NewRangeMin, double NewRangeMax, EViewRangeInterpolation Interpolation )
{
...
void FKuruTimeSliderController::SetClampRange( double NewRangeMin, double NewRangeMax )
{
...
void FKuruTimeSliderController::SetPlayRange( FFrameNumber RangeStart, int32 RangeDuration )
{
...
bool FKuruTimeSliderController::ZoomByDelta( float InDelta, float MousePositionFraction )
{
...
void FKuruTimeSliderController::PanByDelta( float InDelta )
{
...
bool FKuruTimeSliderController::HitTestRangeStart(const FScrubRangeToScreen& RangeToScreen, const TRange<double>& Range, float HitPixel) const
{
...
bool FKuruTimeSliderController::HitTestRangeEnd(const FScrubRangeToScreen& RangeToScreen, const TRange<double>& Range, float HitPixel) const
{
...
bool FKuruTimeSliderController::HitTestTime(const FScrubRangeToScreen& RangeToScreen, double Time, float HitPixel) const
{
...
void FKuruTimeSliderController::SetPlaybackRangeStart(FFrameNumber NewStart)
{
	TRange<FFrameNumber> PlaybackRange = TimeSliderArgs.PlaybackRange.Get();
...
void FKuruTimeSliderController::SetPlaybackRangeEnd(FFrameNumber NewEnd)
{
	TRange<FFrameNumber> PlaybackRange = TimeSliderArgs.PlaybackRange.Get();
...
void FKuruTimeSliderController::SetSelectionRangeStart(FFrameNumber NewStart)
{
	TRange<FFrameNumber> SelectionRange = TimeSliderArgs.SelectionRange.Get();
...
void FKuruTimeSliderController::SetSelectionRangeEnd(FFrameNumber NewEnd)
{
	TRange<FFrameNumber> SelectionRange = TimeSliderArgs.SelectionRange.Get();
...
int32 FKuruTimeSliderController::HitTestTimes(const FScrubRangeToScreen& RangeToScreen, float HitPixel) const
{
	const TArray<double>& Times = mEditingData->EditableItems;
	int32 NumTimes = Times.Num();
	for(int32 TimeIndex = 0; TimeIndex < NumTimes; ++TimeIndex)
	{
		const double Time = mEditingData->EditableItems[TimeIndex];
...
void FKuruTimeSliderController::SetEditableTime(int32 TimeIndex, float Time, bool bIsDragging)
{
	if (mEditingData)
	{
		if (mEditingData->EditableItems.Num()>TimeIndex)
		{
			mEditingData->EditableItems[TimeIndex] = Time;
		}
	}
}
