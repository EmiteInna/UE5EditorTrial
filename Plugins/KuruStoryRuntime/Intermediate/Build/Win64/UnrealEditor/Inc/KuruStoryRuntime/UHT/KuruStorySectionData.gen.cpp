...
// Cross Module References
	...
	KURUSTORYRUNTIME_API UClass* Z_Construct_UClass_UKuruStorySectionData();
...
// End Cross Module References
...
#endif
		{ "IncludePath", "KuruStorySectionData.h" },
		{ "ModuleRelativePath", "KuruStorySectionData.h" },
#if !UE_BUILD_SHIPPING
	...
	template<> KURUSTORYRUNTIME_API UClass* StaticClass<UKuruStorySectionData>()
	{
		return UKuruStorySectionData::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UKuruStorySectionData);
	UKuruStorySectionData::~UKuruStorySectionData() {}
	struct Z_CompiledInDeferFile_FID_KuruADV_Plugins_KuruStoryRuntime_Source_KuruStoryRuntime_KuruStorySectionData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_KuruADV_Plugins_KuruStoryRuntime_Source_KuruStoryRuntime_KuruStorySectionData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UKuruStorySectionData, UKuruStorySectionData::StaticClass, TEXT("UKuruStorySectionData"), &Z_Registration_Info_UClass_UKuruStorySectionData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UKuruStorySectionData), 1863670577U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_KuruADV_Plugins_KuruStoryRuntime_Source_KuruStoryRuntime_KuruStorySectionData_h_2871762723(TEXT("/Script/KuruStoryRuntime"),
		Z_CompiledInDeferFile_FID_KuruADV_Plugins_KuruStoryRuntime_Source_KuruStoryRuntime_KuruStorySectionData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_KuruADV_Plugins_KuruStoryRuntime_Source_KuruStoryRuntime_KuruStorySectionData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
